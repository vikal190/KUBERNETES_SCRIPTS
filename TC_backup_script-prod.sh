...
DIR_PATH="/mnt/c/Users/703375822/Documents/Prod-Backup/$DATESTAMP"

##################################################################################################################################################

# Create a new directory with the datestamp //
mkdir -p "$DIR_PATH/TC_prod_BACKUPS"
...
local_dir="$DIR_PATH/TC_prod_BACKUPS"

# Loop through namespaces
for namespace in "${namespaces[@]}"
do
    # Define the pod for the current namespace //
    pod="${namespace}-prod-thread-connect-0"
...
do
    ...
    pods=("dive-prod-customer-tc-0" "dive-prod-product-tc-0")
